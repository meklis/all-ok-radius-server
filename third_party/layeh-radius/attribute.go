...
func NewUserPassword(plaintext, secret, requestAuthenticator []byte) (Attribute, error) {
	...
	// backport из upstream v0.0.0-20231213012653-1006025d24f8: тут была
	// паника на plaintext[:16] при len(plaintext) < 16 (в т.ч. для
	// пустого пароля, capacity 0) - см. third_party/layeh-radius/README-FORK.md
