...
// Worker class, Worker is a log object used to log events and Color specifies
...
// Logger class that is an interface to user to log events, Module is the module for which we are testing
